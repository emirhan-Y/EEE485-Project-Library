...
class pca:
    ...
    def __init__(self, data_points: Optional[np.ndarray] = None, var_contained: Optional[float] = None):
        ...
        self._required_eigen_values = None
    ...
    def analyze(self):
        ...
        if self._var_contained is None:
            pca._LOGGER.error_message('pca', 'no desired contained variance value was entered to the pca ahead of '
                                             'analysis')
            raise RuntimeError('pca has no desired variance for analysis!')
